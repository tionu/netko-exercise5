	...
	public void start() {
		...
		try {
			...
			if(receivedData.equals("CAPA\r\n")) {
				Utilities.sendData(socket,"+OK List of capabilities follows\r\n"
						+ "TOP\r\n"
						+ "USER\r\n"
						+ "UIDL\r\n"
						+ ".\r\n");
			...
			while(!receivedData.equals("QUIT\r\n")) {
				if(receivedData.equals("STAT\r\n"))
					...
					Utilities.sendData(socket,"+OK scan listing follows\r\n"
							+ "1 17\r\n"
							+ "2 14\r\n"
							+ "3 17\r\n"
							+ ".\r\n");
					...
					Utilities.sendData(socket,"+OK Message follows\r\n"
							+ getHeader(1)
							+ "\r\n"
							+ "Das ist ein Test.\r\n"
							+ ".\r\n");
